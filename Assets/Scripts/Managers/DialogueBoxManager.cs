...
public class DialogueBoxManager : MonoBehaviour
{
    ...
    private DialogueText currentDialogueBox = null;
    ...
    */
    ...
    public void StartDialogue(InteractableObject interaction, DialogueText dialogueText)
    {
        ...
        gameObject.SetActive(true); // Make Dialogue Box visible
    ...
    IEnumerator CO_CloseDialogue()
    {
        ...
        gameObject.SetActive(false); // Make Dialogue Box not visible
