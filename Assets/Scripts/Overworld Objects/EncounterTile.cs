...
public class EncounterTile : InteractableObject
{
    ...
    public override void OnEndInteract() // Occurs only after the dialogue has concluded
    {
        ...
        encounterManager.StartEncounter(chosenEncounter.Handler, chosenEncounter.Critter1, chosenEncounter.Critter2, chosenEncounter.Critter3);
    }
}
...
public class EncounterData
{
    ...
    [SerializeField] private CritterSlot enemyHandler;
    ...
    public CritterSlot Handler { get { return enemyHandler; } }
